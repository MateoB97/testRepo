        ...
        DB::statement("CREATE view AccountInterfaceView
            ...
            from (
                select
                    ...
                    fac_movimientos.fac_tipo_doc_id,
                    te.documento as nit
                ...
                inner join gen_iva iv on iv.id = a.gen_iva_id
                ...
                inner join terceros te on ts.tercero_id = te.id
            )dd group by dd.prefijo, dd.consecutivo, dd.fecha_facturacion, dd.cuenta_contable_venta, dd.valor_porcentaje, dd.cuenta_contable_iva, dd.nombre_contable_venta, dd.nombre_contable_iva, dd.fac_tipo_doc_id, dd.nit");
    }
