...
<body>
						...
						<tbody>
							<tr>
								<td colspan="2" class="text-center">
									<h3>{{  $tipoOrden->nombre }}</h3>
								</td>
							</tr>
							<tr>
								<td class="text-center">
									<p>N° {{ $orden->consecutivo }}</p>
								</td>
								<td class="text-center">
	...
	<table class="table-info">
		<tbody>
			<tr>
				<td class="w2tercio">
					<h3>{{  strtoupper($tipoOrden->nombre) }} PARA:</h3>
				...
				<td class="wtercio">
					<p><strong>Fecha orden:</strong> {{ $orden->fecha_orden }} </p>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="table-info">
		<tbody>
			<tr>
				...
				<td class="wmediotercio text-center">
					<p>${{ number_format($orden->subtotal, 0, ',', '.') }}</p>
					<p>${{ number_format($orden->descuento, 0, ',', '.') }}</p>
					<p>${{ number_format($orden->ivatotal, 0, ',', '.') }}</p>
					<p>${{ number_format($orden->total, 0, ',', '.') }}</p>
				</td>
			</tr>
		</tbody>
	</table>
