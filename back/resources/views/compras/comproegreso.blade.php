...
<body>
	<table class="table-info">
		<tbody>
			<tr>
				...
				<td class="wtercio text-center">
					<p><strong>{{ strtoupper($tipoComproEgreso->nombre) }}</strong></p>
					<p>N° {{ $comprobante->consecutivo }}</p>
	...
	<table class="table-info">
		<tbody>
			<tr>
				...
				<td class="wmediotercio text-center">
					<p>${{ number_format($comprobante->total, 2, ',', '.') }}</p>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="table table-info">
		...
		<tbody>
			<tr>
				<td><p>{{ $comprobante->ajuste_observacion }}</p></td>
			</tr>
		</tbody>
	</table>
